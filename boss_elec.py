...
class Boss(pygame.sprite.Sprite):
    ...
    def update_health_bar(self, surface):
        pygame.draw.rect(surface, (60, 63, 60), [self.rect.x, self.rect.y + 138, int(self.max_health*11.6), 5])
        pygame.draw.rect(surface, (111, 210, 46), [self.rect.x, self.rect.y + 138, int(self.health*11.6), 5])